...
const BillPage = () => {
  ...
  const [filterPage, setFilterPage] = React.useState(() => {
    const dataFilter = getItemLocalStore("salesInvoicesPageFilter");
  ...
  const LoadData = async () => {
    ...
    setIsBusy(true);
    setItemLocalStore("salesInvoicesPageFilter", filterPage);
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="Sales Invoices" preLink="" />
